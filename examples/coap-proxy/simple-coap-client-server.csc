...
<simconf>
  ...
  <simulation>
    <title>CoAP Simple Client/Server</title>
    ...
    <motetype>
      ...
      <description>Simple CoAP Server</description>
    ...
    <motetype>
      ...
      <description>Simple CoAP Client</description>
    ...
    <mote>
      <interface_config>
        ...
        <x>29.94047719573971</x>
        <y>99.82773505700719</y>
        <z>0.0</z>
      </interface_config>
      <interface_config>
    ...
    <mote>
      <interface_config>
        org.contikios.cooja.interfaces.Position
        <x>49.80757451902708</x>
        <y>99.71625765239799</y>
        <z>0.0</z>
      </interface_config>
      <interface_config>
        org.contikios.cooja.contikimote.interfaces.ContikiMoteID
  ...
  <plugin>
    ...
    <plugin_config>
      ...
      <viewport>14.433572015148103 0.0 0.0 14.433572015148103 -376.7166247752273 -1188.2813150568259</viewport>
    </plugin_config>
    <width>400</width>
    <z>1</z>
    <height>400</height>
